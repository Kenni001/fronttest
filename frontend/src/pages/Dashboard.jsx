      ...
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-blue-400 to-purple-500 p-6">
        <div className="w-full max-w-4xl bg-white p-8 rounded-lg shadow-xl space-y-8">
          ...
          >
            ...
            >
              <h2 className="font-semibold text-xl mb-5 text-blue-600">Profile Info</h2>
              <motion.p className="text-xl text-gray-700"><strong>Name:</strong> {user.firstName} {user.lastName}</motion.p>
              <motion.p className="text-xl text-gray-700"><strong>Email:</strong> {user.email}</motion.p>
              {/* <motion.p className="text-lg text-gray-700"><strong>Phone:</strong> {user.phone || 'Not Provided'}</motion.p>
              <motion.p className="text-lg text-gray-700"><strong>Address:</strong> {user.address || 'Not Provided'}</motion.p> */}
              <motion.p className="text-xl text-gray-700"><strong>Membership Status:</strong> {user.membershipStatus}</motion.p>
              <motion.p className="text-xl text-gray-700"><strong>Membership Type:</strong> {user.membershipType}</motion.p>
              <motion.p className="text-xl text-gray-700"><strong>Planner ID:</strong> {user.plannerId}</motion.p>
            </motion.div>
