        ...
        <div className="container mx-auto px-4">
          ...
          <section className="membership-types grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 py-10">
            <div className="card p-6 bg-white rounded-lg shadow-lg transform hover:scale-105 transition duration-500 ease-in-out hover:shadow-2xl">
              ...
              <p className="text-lg text-gray-600">
                Members with expertise in spatial planning, land use planning,
                and urban design.
              </p>
            </div>
            <div className="card p-6 bg-white rounded-lg shadow-lg transform hover:scale-105 transition duration-500 ease-in-out hover:shadow-2xl">
              ...
              <p className="text-lg text-gray-600">
                Members with expertise in social development and economic
                planning.
              </p>
            </div>
            <div className="card p-6 bg-white rounded-lg shadow-lg transform hover:scale-105 transition duration-500 ease-in-out hover:shadow-2xl">
              ...
              <p className="text-lg text-gray-600">
                Members with expertise in environmental planning, management and
                climate change.
              </p>
            </div>
          </section>
          ...
          <section className="membership-benefits py-10">
            ...
            <p className="text-center mt-6 animate__animated animate__fadeIn animate__delay-2s">
              To join ZIP, please{" "}
              <a className="btn btn-primary text-white bg-indigo-600 py-2 px-4 rounded-lg shadow-md hover:bg-indigo-700 transform hover:scale-105 transition duration-300">
