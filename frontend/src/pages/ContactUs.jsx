      ...
      <div className="contact-us bg-gray-50 py-10 pt-20">
        <div className="container mx-auto px-4">
          ...
          <section className="contact-info py-10">
            <h3 className="text-3xl font-semibold text-center text-gray-800 mb-6 animate__animated animate__fadeIn animate__delay-1.5s">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-lg text-gray-700">
                Phone: <span className="text-indigo-600">+260773992358 </span>
              </p>
              <p className="text-lg text-gray-700">
                Address: Block 2 Room 2, Fairley Road, Lusaka,
                Zambia
              </p>
            </div>
          </section>
          ...
          <section className="contact-form py-10">
            <h3 className="text-3xl font-semibold text-center text-gray-800 mb-6 animate__animated animate__fadeIn animate__delay-2s">
              Send Us a Message
            </h3>
            <form
              onSubmit={handleSubmit}
              className="max-w-2xl mx-auto space-y-6 bg-white p-8 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 ease-in-out hover:shadow-2xl"
            >
