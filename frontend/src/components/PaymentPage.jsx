  ...
  const membershipOptions = [
    {
      type: "Membership I",
      price: 100,
      benefits: ["Access to events", "Monthly newsletter"],
    },
    {
      type: "Membership II",
      price: 200,
      benefits: ["All Membership I benefits", "Discounted services"],
    },
    {
      type: "Membership III",
      price: 300,
      benefits: [
        "All Membership II benefits",
        "Priority support",
        "Exclusive content",
      ],
    },
  ...
  const handlePayment = async () => {
    ...
    try {
      const response = await axios.post(
        "https://fronttest-taupe.vercel.app/api/payments/create-intent",
        {
          amount,
          currency: "USD",
        }
      ...
      setPaymentStatus(
        "Payment initiated successfully! Complete it using Stripe."
      );
    } catch (error) {
          ...
          <div className="space-y-4 mb-6">
            {membershipOptions.map((option, index) => (
              <div
                ...
                onClick={() =>
                  handleMembershipChange(option.type, option.price)
                }
              >
